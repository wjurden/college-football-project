...
# Configuring API
#===============================
endpoint = 'https://api.collegefootballdata.com/games?year=2022&seasonType=postseason' #Setting year to 2022, and season to postseason
...
df.to_csv('postseason_game_data_2022_raw.csv', index= False)